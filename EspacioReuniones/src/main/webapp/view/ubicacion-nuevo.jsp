                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtNombre" id="txtNombre" 
                                           value="${ubicacion.nombre}" class="form-control" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtDireccion" id="txtDireccion" 
                                           value="${ubicacion.direccion}" class="form-control" 
                        ...
                        <table class="table table-hover" id="mi_tabla">
                            ...
                            <tbody>
                                <c:forEach var="ubi" items="${ubicaciones}">
                                    <tr>
                                        <td class="text-center">${ubi.getId()}</td>
                                        <td>${ubi.getNombre()}</td>
                                        <td>${ubi.getDireccion()}</td>
                                        <td class="text-center">
                                            <a class="btn btn-warning btn-icon" id="btned" 
                                               href="UbicacionServlet?action=editar&id=${ubi.getId()}" 
                                               title="Editar">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a>
                                            <a class="btn btn-danger btn-icon" id="btnq" 
                                               href="UbicacionServlet?action=eliminar&id=${ubi.getId()}"
