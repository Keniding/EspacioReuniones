...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <%-- Mostrar "Usuarios" solo para superadministradores --%>
            ...
            <%-- Mostrar "Perfil" para todos los demás usuarios --%>
            <c:if test="${sessionScope.rol != 'Superadministrador'}">
                <li class="nav-item"><a class="nav-link" href="UsuarioServlet?action=editar&id=${sessionScope.usuarioId}">Perfil</a></li>
            </c:if>
