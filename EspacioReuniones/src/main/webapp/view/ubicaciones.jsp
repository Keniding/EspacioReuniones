...
<body>
    <div class="container mt-4">
        ...
        <a href="UbicacionServlet?action=nuevo" class="btn btn-primary mb-3">Agregar Nueva Ubicación</a>
                    ...
                    <c:forEach var="ubicacion" items="${ubicaciones}">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="UbicacionServlet?action=editar&id=${ubicacion.id}" class="btn btn-warning">Editar</a>
                                <a href="UbicacionServlet?action=eliminar&id=${ubicacion.id}" class="btn btn-danger">Eliminar</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
